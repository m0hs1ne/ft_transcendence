...
<template>
	<div v-if="this.friendTab" class="flex flex-col justify-start items-center min-h-screen dark:bg-slate-800 p-10 ml-20">
	...
	<div class="grid grid-cols-1 md:grid-cols-2 gap-10 p-10 ml-20
		...
		<div
			...
			<p class=" font-semibold text-3xl tracking-wide mx-5 mt-5 mb-7 dark:text-white">
				{{ this.username }}
			</p>
			<div class="flex items-center">
			...
			<div @click="this.friendTab = true"
				class="flex items-center h-[50px] px-3 mt-5 justify-center text-gray-700  font-bold text-xl cursor-pointer bg-gray-200 rounded-lg shadow-lg">
				View Friends
			</div>
		</div>
