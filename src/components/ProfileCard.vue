...
<template>
	<div class="relative h-[480px] flex flex-col items-center rounded-2xl custom-box-shadow dark:bg-slate-900">
		<div 
			class="absolute w-full h-[140px] bg-blue-200 rounded-t-2xl top-0 left-0 right-0">
		</div>
		<div class="absolute flex flex-col gap-5 items-center rounded-2xl top-[70px]">
