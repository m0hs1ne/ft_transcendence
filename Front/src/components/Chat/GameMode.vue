<template>
    <div>
        <div v-if="isOpend" class="fixed inset-0 flex items-center justify-center bg-white dark:bg-slate-800">
                ...
                <div>
                    <div class="my-5">
                        ...
                        <select v-model="selectedOption"
                            class="bg-white border border-gray-300 px-4 py-2 rounded dark:bg-slate-800 dark:text-white">
    ...
    methods: {
        ...
        async SaveChannel() {
            ...
            this.$GameSocket.on("start", (data) => {
                this.gameData.setData(this.selectedOption, '', false);
