      ...
      <li v-for="(conversation, index) in this.userStore.DmChatroomsList" :key="index"
        ...
        <div class="flex w-full">
          <div class="w-12 bg-gray-200 rounded-full shadow mr-4">
            <img v-if="conversation.avatar" :src="conversation.avatar" alt="Avatar"
          ...
          <div class="flex flex-col items-start justify-center">
            <span class="text-lg font-bold text-ellipsis line-clamp-1">{{ conversation.username }} {{ conversation.title
            }}</span>
